...
import { BarType } from '@devexperts/dxcharts-lite/dist/chart/chart.config';
...
import { Price } from '@devexperts/dxcharts-lite/dist/chart/model/scaling/viewport.model';
import VisualCandle from '@devexperts/dxcharts-lite/dist/chart/model/visual-candle';
import { DateTimeFormatterFactory } from '@devexperts/dxcharts-lite/dist/chart/model/date-time.formatter';
import { Observable } from 'rxjs';
import { ChartWithDrawings, Drawing, FullChartConfigDrawings, SnapMode } from './drawings.config';
import { DrawingConfig, DrawingModel, InitialDrawingConfig } from './model/drawing.model';
import DrawingsModel, { NullableDrawingModel } from './model/drawings.model';
import { DrawingType } from './model/drawing-types';
import { DynamicObjectsComponent } from '@devexperts/dxcharts-lite/dist/chart/components/dynamic-objects/dynamic-objects.component';
...
export declare class DrawingsComponent extends ChartBaseElement {
    ...
    constructor(chartBootstrap: ChartWithDrawings, eventBus: EventBus, elements: ValidatedChartElements, config: FullChartConfigDrawings, chartModel: ChartModel, canvasBoundsContainer: CanvasBoundsContainer, canvasInputListener: CanvasInputListenerComponent, hitTestCanvasModel: HitTestCanvasModel, formatterFactory: DateTimeFormatterFactory, xAxisComponent: XAxisComponent, yAxis: YAxisComponent, chartPanComponent: ChartPanComponent, paneManager: PaneManager, cursorHandler: CursorHandler, timeZoneModel: TimeZoneModel, dynamicObjects: DynamicObjectsComponent);
    protected doActivate(): void;
    clearDrawingsDynamicObjects(): void;
    addDrawingsToDynamicObjects(): void;
    syncDrawingsWithDynamicObjects(): void;
    updateDrawingLabels(): void;
    ...
    getDrawing<T extends DrawingType>(id: string): DrawingModel<T> | undefined;
    ...
    /**
     * Creates or updates drawing on chart.
     * @param instrumentCode
     * @param drawing
     */
    setDrawing<T extends DrawingType>(instrumentCode: string, drawing: DrawingModel<T>): void;
    /**
     ...
     */
    observeDrawingMoved(): Observable<DrawingModel<DrawingType>>;
    observeDrawingFinished(): Observable<NullableDrawingModel>;
    observeDrawingRemoved(): Observable<NullableDrawingModel[]>;
    observeDrawingsUpdated(): Observable<DrawingModel<DrawingType>[]>;
    observeDrawingModified(): Observable<NullableDrawingModel>;
    /**
