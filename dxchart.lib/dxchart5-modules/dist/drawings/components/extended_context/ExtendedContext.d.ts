...
export declare class ExtendedContext {
    ...
    constructor(context: CanvasRenderingContext2D, chart: ChartWithDrawings);
    ...
    isRectInViewport(a: Vector, b: Vector, bounds?: Bounds): boolean;
    isPolygonInViewport(pts: Vector[], bounds?: Bounds): boolean;
    ...
    getRightRayPath(a: Vector, bounds?: Bounds): Vector[] | undefined;
    /**
    ...
    addRectPath(a: Vector, b: Vector, bounds?: Bounds): void;
    addLinePath(a: Vector, b: Vector): void;
    addPolygonPath(pts: Vector[], bounds?: Bounds): void;
    ...
    addEllipsePath(r: Vector, s: Vector, t: Vector, bounds?: Bounds): Vector[];
     ...
     * @param a {Vector}
     * @param b {Vector}
     * @param drawingBounds {Bounds | null}
     */
    addFillBetweenRaysPath(start: Vector, a: Vector, b: Vector, drawingBounds?: Bounds): void;
    isHitTest(): boolean;
