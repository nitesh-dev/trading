...
interface EventsPopoverStyledProps {
    readonly verticalMargin: number;
}
export declare const EventsPopoverStyled: import("styled-components").StyledComponent<import("react").FC<import("react").PropsWithChildren<import("../../../chart-kit/Popover/Popover.component").CKPopoverProps>>, any, EventsPopoverStyledProps, never>;
