...
export declare const SITimeInput: React.MemoExoticComponent<React.ForwardRefExoticComponent<Pick<React.PropsWithChildren<CKInputProps>, "value" | "error" | "pattern" | "name" | "key" | "min" | "id" | "type" | "children" | "className" | "placeholder" | "tabIndex" | "role" | "onFocus" | "onBlur" | "onChange" | "onKeyDown" | "onKeyPress" | "onKeyUp" | "onClick" | "onMouseDown" | "onMouseEnter" | "onMouseLeave" | "onMouseUp" | "onTouchCancel" | "onTouchEnd" | "onTouchMove" | "onTouchStart" | "onWheel" | "testId" | "onValueChange" | "ariaLabel" | "max" | "isDisabled" | "isReadOnly" | "autofocus" | "ariaDescribedby"> & React.RefAttributes<HTMLElement>>>;
